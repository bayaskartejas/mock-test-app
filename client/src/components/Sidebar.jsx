    ...
    return (
        <div className='w-72 rounded-md h-full fixed top-0 left-0 px-5 shadow-xl bg-white'>
            ...
            <div className='mt-10 mb-5'>
                <ul>
                    <li id='hometab' onClick={()=>{navigate("/home")}} className='h-14 w-full rounded-md hover:bg-gray-200 flex items-center pl-5 cursor-pointer'>
                        <img src={home} alt="" className='h-8'/>
                        <h1 className='ml-5'>Home</h1>
                    </li>
                    <li id='dashtab' onClick={()=>{navigate("/dashboard")}} className='mt-2 h-14 w-full rounded-md hover:bg-gray-200 flex items-center pl-5 cursor-pointer'>
                        <img src={dashboard} alt="" className='h-8'/>
                        <h1 className='ml-5'>Dashboard</h1>
                    </li>
                    <li id='teststab' onClick={()=>{navigate("/tests")}} className='mt-2 h-14 w-full rounded-md hover:bg-gray-200 flex items-center pl-5 cursor-pointer'>
                        <img src={tests} alt="" className='h-8'/>
                        <h1 className='ml-5'>Tests</h1>
                    </li>
                    <li id='settingstab' onClick={()=>{navigate("/settings")}} className='mt-2 h-14 w-full rounded-md hover:bg-gray-200 flex items-center pl-5 cursor-pointer'>
                        <img src={settings} alt="" className='h-8'/>
                        <h1 className='ml-5'>Settings</h1>
                    </li>
                    <li id='accounttab' onClick={()=>{navigate("/account")}} className='mt-2 h-14 w-full rounded-md hover:bg-gray-200 flex items-center pl-5 cursor-pointer'>
            ...
            <div className='mt-5'>
                <ul>
                    <li onClick={()=>{setShowLogout(true)}} className='h-14 w-full rounded-md hover:bg-gray-200 flex items-center pl-6 cursor-pointer'>
