...
function Greet() {
  return (
    <div className='h-max'>
      <div className='w-full flex justify-center text-slate-500 text-2xl sm:text-4xl tracking-wide font-semibold text-center items-center'>Hi {localStorage.getItem("rememberMe")=="true" ? localStorage.getItem("name") : name = sessionStorage.getItem("name")},</div>
