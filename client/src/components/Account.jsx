...
function Account({ showLogout, setShowLogout, showMenu, setShowMenu, children }) {
...
useEffect(()=>{
    if(showMenu){
      document.getElementById("sideAcc").style.display = "flex"
    }
    else{
      document.getElementById("sideAcc").style.display = "none"
    }
  },[showMenu])
    return (
        <div className='bg-slate-200 h-full'>
            ...
            <div id='sideAcc' className='hidden xl:flex'>
                {children}
            </div>
