  ...
  function Signup({setToSignup, setToSignin, setToOtpPage, newOtp, setNewOtp}) {
    ...
    return <div className='bg-white w-96 h-96 justify-self-center shadow-lg rounded-lg md:px-7 px-4 py-8 transform transition-transform duration-300 scale-95'>
      ...
      <div className='flex justify-center'>
        <button type='submit' className='flex text-white text-lg bg-green-201 w-full py-2 rounded-md hover:bg-green-101 transition delay-100 hover:shadow-md justify-center mt-4'>Sign up</button>
      </div>
      </form>
