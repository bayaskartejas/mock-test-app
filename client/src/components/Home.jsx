...
function Home() {
  ...
  useEffect(()=>{
    if(moreClicked){
      ...
      document.getElementById("parent").className = "sm:flex flex mt-6 sm:mt-10 bp:mt-14 bp:grid bp:grid-cols-1 grid-cols-2 items-center justify-center"
  ...
  return <div className=' bg-slate-200 h-full'>
    ...
    <div className='bp:mt-[6rem] sm:mt-[3rem] mt-16 xl:ml-72 flex-grow'>
      <Greet />
        <div id='parent' className='h-max sm:flex flex mt-6 sm:mt-10 bp:mt-14 bp:grid bp:grid-cols-1 grid-cols-2 items-center justify-center'>
          ...
          <div id='moreRef' className= 'hidden sm:grid grid-cols-1 h-max sm:mt-4 bp:flex justify-around pl-2 w-max xl:w-[calc(100%-18rem)] justify-self-center'>
