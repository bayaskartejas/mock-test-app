...
function Settings({ showLogout, setShowLogout, showMenu, setShowMenu, children }) {
    ...
    useEffect(()=>{
        if(showMenu){
          document.getElementById("sideSett").style.display = "flex"
        }
        else{
          document.getElementById("sideSett").style.display = "none"
        }
      },[showMenu])
    return (
        <div className='bg-slate-200 h-full'>
            ...
            <div id='sideSett' className='hidden xl:flex'>
                {children}
            </div>
